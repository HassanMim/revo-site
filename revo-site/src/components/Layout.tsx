...
export default function Layout() {
  ...
  const activeClass = useMemo(() => "text-slate-900 font-semibold", []);
      ...
      <header className="sticky top-0 z-40 border-b border-slate-200/30 bg-background/90 backdrop-blur">
        <Container className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center gap-2">
            <img src="/assets/img/logo.png" alt="REVO" className="w-32 h-6" />
          </Link>
          {/* scroll progress */}
          ...
          >
            <img
              ...
              alt=""
              className={`h-7 w-7 transition duration-200 ease-in-out ${open ? "rotate-[360deg]" : "rotate-0"}`}
            />
          </button>
        </Container>
        ...
        {open && (
          <div className="md:hidden">
            <Container>
              <div
                ref={panelRef}
                className="p-4 my-3 bg-white border shadow-sm rounded-2xl border-slate-200"
              >
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-[#B9C3E6]">
                  Real Estate Virtual Ops
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center text-sm gap-x-6 gap-y-2 text-white/75">
              ...
              <a href="mailto:info@revoeg.com" className="hover:text-white">
                info@revoeg.com
              </a>
            </div>
          </div>
